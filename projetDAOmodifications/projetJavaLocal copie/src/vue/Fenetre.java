...
public class Fenetre extends JFrame{
  ...
  public Fenetre(){
    ...
    card1.setBorder(BorderFactory.createTitledBorder("Rechercher")); 
    //card1.setBackground(Color.blue);	
    //Update
    panelUpdate card2 = new panelUpdate();
    card2.setBorder(BorderFactory.createTitledBorder("Mettre à jour")); 
    //card2.setBackground(Color.red);	
    //Create
    panelCreate card3 = new panelCreate();
    card3.setBorder(BorderFactory.createTitledBorder("Ajout")); 
    //card3.setBackground(Color.green);
    //Delete
    panelDelete card4 = new panelDelete();
    card4.setBorder(BorderFactory.createTitledBorder("Supprimer")); 
