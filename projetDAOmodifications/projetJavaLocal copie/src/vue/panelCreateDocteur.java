 ...
 * @author Pierre-Louis
 */
public class panelCreateDocteur extends JPanel {
    ...
    public panelCreateDocteur(){
      ...
      fieldsPane1.setBorder(BorderFactory.createTitledBorder("Creation d'un Docteur"));
      ...
      fieldsPane1.add(ajouter, BorderLayout.EAST);
